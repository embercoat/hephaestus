<form action=":::url:/admin/movie/<?php echo ((isset($data['movie_id'])) ? 'edit/'.$data['movie_id'] : 'new_movie'); ?>:::" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <p style="float: left; clear: both;">Nuvarande Poster<br ><a href=":::file:<?php echo ((isset($data['poster'])) ? $data['poster'] : ''); ?>:::"><img src=":::file:<?php echo ((isset($data['poster'])) ? $data['poster'] : ''); ?>:::" style="height: 200px;" /></a></p>
